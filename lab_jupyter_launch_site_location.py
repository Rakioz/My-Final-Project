...
circle1 = folium.Circle(CCAFS_coordinate, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('CCAFS LC-40'))

circle2 = folium.Circle(CCAFSS_coordinate, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('CCAFS SLC-40'))

circle3 = folium.Circle(KSC_coordinate, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('KSC LC-39A'))

circle4 = folium.Circle(VAFB_coordinate, radius=1000, color='#d35400', fill=True).add_child(folium.Popup('VAFB SLC-4E'))
...
distance_coastline = calculate_distance(28.56314, -80.57678, 28.56451, -80.56813)
...
points=[[28.56314, -80.57678],[28.56451, -80.56813]]
lines=folium.PolyLine(points, weight=3)
...
distance_highway = calculate_distance(28.56314, -80.57678, 28.55189, -80.56894)
...
points2=[[28.56314, -80.57678],[28.55189, -80.56894]]
lines2=folium.PolyLine(points2, weight=3)
